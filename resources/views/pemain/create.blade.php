<x-hero-section>
    <div class="text-white border border-white rounded max-w-sm text-center">
        <h3 class="my-3 font-bold text-lg">Tambah Data Pemain</h3>
    </div>
    ...
    <div class="mt-5">
        <form method="POST" action="{{ route('pemain.store') }}">
            ...
            <div class="mt-4">
                ...
                <x-text-input id="nama_murid" class="block mt-1 w-full" type="text" name="nama_murid" :value="old('nama_murid')" required autocomplete="username" />
